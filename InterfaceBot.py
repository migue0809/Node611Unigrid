...
BD1=Button(root,text="D1",command=obtenerD1,background="#FFFFFF",bd=1,width=1, height=1).place(x=200,y=326)
BD2=Button(root,text="D2",command=obtenerD2,background="#FFFFFF",bd=1,width=1, height=1).place(x=182,y=292)
BD3=Button(root,text="D3",command=obtenerD3,background="#FFFFFF",bd=1,width=1, height=1).place(x=182,y=251)
BD4=Button(root,text="D4",command=obtenerD4,background="#FFFFFF",bd=1,width=1, height=1).place(x=182,y=210)
BD5=Button(root,text="D5",command=obtenerD5,background="#FFFFFF",bd=1,width=1, height=1).place(x=10,y=20)
BD6=Button(root,text="D6",command=obtenerD6,background="#FFFFFF",bd=1,width=1, height=1).place(x=30,y=40)
BD7=Button(root,text="D7",command=obtenerD7,background="#FFFFFF",bd=1,width=1, height=1).place(x=50,y=60)
BD8=Button(root,text="D8",command=obtenerD8,background="#FFFFFF",bd=1,width=1, height=1).place(x=70,y=80)
BD9=Button(root,text="D9",command=obtenerD9,background="#FFFFFF",bd=1,width=1, height=1).place(x=90,y=100)
BS1=Button(root,text="S1",command=obtenerS1,background="#FFFFFF",bd=1,width=1, height=1).place(x=110,y=20)
BS2=Button(root,text="S2",command=obtenerS2,background="#FFFFFF",bd=1,width=1, height=1).place(x=130,y=40)
BS3=Button(root,text="S3",command=obtenerS3,background="#FFFFFF",bd=1,width=1, height=1).place(x=150,y=60)
BS4=Button(root,text="S4",command=obtenerS4,background="#FFFFFF",bd=1,width=1, height=1).place(x=170,y=80)
BS5=Button(root,text="S5",command=obtenerS5,background="#FFFFFF",bd=1,width=1, height=1).place(x=190,y=100)
BS6=Button(root,text="S6",command=obtenerS6,background="#FFFFFF",bd=1,width=1, height=1).place(x=210,y=120)
BS7=Button(root,text="S7",command=obtenerS7,background="#FFFFFF",bd=1,width=1, height=1).place(x=230,y=140)
BS8=Button(root,text="S8",command=obtenerS8,background="#FFFFFF",bd=1,width=1, height=1).place(x=250,y=160)
BS9=Button(root,text="S9",command=obtenerS9,background="#FFFFFF",bd=1,width=1, height=1).place(x=270,y=180)
BS10=Button(root,text="S10",command=obtenerS10,background="#FFFFFF",bd=1,width=2, height=1).place(x=290,y=200)
BS11=Button(root,text="S11",command=obtenerS11,background="#FFFFFF",bd=1,width=2, height=1).place(x=310,y=220)
BS12=Button(root,text="S12",command=obtenerS12,background="#FFFFFF",bd=1,width=2, height=1).place(x=330,y=240)
